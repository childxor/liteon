...
class It_brands extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['module'] = 'main/it/it_brands';
    ...
    public function getDeviceType($id)
    {
        ...
        $deviceType = $this->db->get_where('it_Brands', array('id' => $id))->row();
