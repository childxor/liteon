...
class It_locations extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['module'] = 'main/it/it_locations';
    ...
    public function savelocations()
    {
        ...
        $this->db->insert('it_locations', $data);
    ...
    public function updateIsActive()
    {
        ...
        $this->db->update('it_locations', $data);
