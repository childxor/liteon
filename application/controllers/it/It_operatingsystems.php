...
class It_operatingsystems extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['module'] = 'main/it/it_operatingsystems';
    ...
    public function saveoperatingsystems()
    {
        $data = array(
        ...
        $this->db->insert('it_operatingsystems', $data);
    ...
    public function updateIsActive() 
    {
        ...
        $this->db->update('it_operatingsystems', $data);
    ...
    public function deleteoperatingsystems($id)
    {
