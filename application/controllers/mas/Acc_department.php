...
class Acc_department extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['module'] = 'main/mas/acc_department';
    ...
    function sort()
    {
        ...
        $id = $this->efs_lib->decrypt_segment($this->input->post('id'));
        $this->db->where('id', $id);
        $this->db->update('mas_acc_department', $data);
        $this->log_lib->write_log('acc_department => ' . 'จัดลำดับข้อมูลเสร็จสิ้น', json_encode($this->db->last_query()));
    }
    ...
    function add()
    {
        ...
        if (!$this->db->insert('mas_acc_department', $data)) {
            $this->session->set_flashdata('type', 'error');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_cannot_add);
            /* Create Log Data  */
            $this->log_lib->write_log('error-acc_department-add=> ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
        } else {
            $this->session->set_flashdata('type', 'success');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_save_success);
            $this->log_lib->write_log('acc_department => ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
        }
    ...
    function edit()
    {
        ...
        $id = $this->efs_lib->decrypt_segment($this->input->post('id'));
        $this->db->where('id', $id);
        if (!$this->db->update('mas_acc_department', $data)) {
            $this->session->set_flashdata('type', 'error');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_cannot_update);
            /* Create Log Data  */
            $this->log_lib->write_log('error-acc_department-update=> ' . $this->session->flashdata('msg'), json_encode($data));
        } else {
            $this->session->set_flashdata('type', 'success');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_save_success);
            $this->log_lib->write_log('acc_department => ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
    ...
    function delete()
    {
        ...
        if (!$this->db->update('mas_acc_department', $data)) {
            ...
            /* Create Log Data  */
            $this->log_lib->write_log('error-acc_department-delete=> ' . $this->session->flashdata('msg'), json_encode($data));
        } else {
            $this->session->set_flashdata('type', 'success');
    ...
    function change_active()
    {
        ...
        if (!$this->db->update('mas_acc_department', $data)) {
            ...
            $this->session->set_flashdata('msg', $this->lang->sys_msg_cannot_update);
            /* Create Log Data  */
            $this->log_lib->write_log('error-acc_department-active=> ' . $this->session->flashdata('msg'), json_encode($data));
        } else {
            $this->session->set_flashdata('type', 'success');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_save_success);
            $this->log_lib->write_log('acc_department => ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
