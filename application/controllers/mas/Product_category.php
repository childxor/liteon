...
class Product_category extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['module'] = 'main/mas/product_category';
    ...
    function ajax_data()
    {
        ...
        $sql = "SELECT * FROM mas_product_category WHERE record_status='N' AND id ='" . $id . "'";
    ...
    function add()
    {
        ...
        if (!$this->db->insert('mas_product_category', $data)) {
            $this->session->set_flashdata('type', 'error');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_cannot_add);
            /* Create Log Data  */
            $this->log_lib->write_log('error-product-category-add=> ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
        } else {
            $this->session->set_flashdata('type', 'success');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_save_success);
            $this->log_lib->write_log('Product Category => ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
        }
    ...
    function edit()
    {
        ...
        $id = $this->efs_lib->decrypt_segment($this->input->post('id'));
        $this->db->where('id', $id);
        if (!$this->db->update('mas_product_category', $data)) {
            $this->session->set_flashdata('type', 'error');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_cannot_update);
            /* Create Log Data  */
            $this->log_lib->write_log('error-product-category-update=> ' . $this->session->flashdata('msg'), json_encode($data));
        } else {
            $this->session->set_flashdata('type', 'success');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_save_success);
            $this->log_lib->write_log('Product Category => ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
    ...
    function delete()
    {
        ...
        if (!$this->db->update('mas_product_category', $data)) {
            ...
            /* Create Log Data  */
            $this->log_lib->write_log('error-product-category-delete=> ' . $this->session->flashdata('msg'), json_encode($data));
        } else {
            $this->session->set_flashdata('type', 'success');
    ...
    function change_active()
    {
        ...
        if (!$this->db->update('mas_product_category', $data)) {
            ...
            $this->session->set_flashdata('msg', $this->lang->sys_msg_cannot_update);
            /* Create Log Data  */
            $this->log_lib->write_log('error-product-category-active=> ' . $this->session->flashdata('msg'), json_encode($data));
        } else {
            $this->session->set_flashdata('type', 'success');
            $this->session->set_flashdata('msg', $this->lang->sys_msg_save_success);
            $this->log_lib->write_log('Product Category => ' . $this->session->flashdata('msg'), json_encode($this->db->last_query()));
