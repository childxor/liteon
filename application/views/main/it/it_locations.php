            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="locationsModalLabel"><i class="fas fa-desktop mr-2"></i><span id="modalTitle">Add Device Type</span></h5>
    ...
    <script type="text/javascript">
        ...
        ! function(window, document, $) {
            ...
            locationsTable = $('#locationsTable').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('it/it_locations/getlocations'); ?>",
                    "type": "POST",
                    "data": function(data) {
                        data.name = $('#name').val();
        ...
        $(document).ready(function() {
            ...
            $('#locationsForm').submit(function(e) {
                ...
                $.ajax({
                    url: '<?php echo base_url('it/it_locations/savelocations'); ?>',
                    type: 'POST',
                    data: formData,
            ...
            $(document).on('click', '.deletelocations', function() {
                ...
                swal.fire({
                    ...
                    if (result) {
                        $.ajax({
                            url: '<?php echo base_url('it/it_locations/deletelocations/'); ?>' + id,
                            type: 'POST',
                            success: function(response) {
                                locationsTable.ajax.reload();
            ...
            $(document).on('change', '.isActive', function() {
                ...
                $.ajax({
                    url: '<?php echo base_url('it/it_locations/updateIsActive'); ?>',
                    type: 'POST',
                    data: {
                        id: id,
