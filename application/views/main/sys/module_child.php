...
<?php if (!empty($this->efs_lib->is_can($permission, "view"))) { /* Can View */ ?>
    ...
    <?php if ($this->efs_lib->is_can($permission, "add")) { ?>
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel">
            <form id="addForm" method="post" action="<?php echo base_url('sys/module/child_add'); ?>" novalidate>
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="parent_module_id" value="<?php echo $this->uri->segment(4); ?>">
                            <div class="form-group">
    ...
    <?php if ($this->efs_lib->is_can($permission, "edit")) { ?>
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
            <form id="editForm" method="post" action="<?php echo base_url('sys/module/child_edit'); ?>" novalidate>
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="addModalLabel"><?php echo $lang_module->lbl_edit; ?></h4>
    ...
    <script type="text/javascript">
        ...
        ! function(window, document, $) {
            ...
            provTable = $('#mTable').DataTable({
                ...
                "ajax": "<?php echo base_url('sys/module/child_ajax_list/' . $this->uri->segment(4)); ?>",
                "deferRender": true,
                "aLengthMenu": [
                    [10, 25, 50, 100],
                    [10, 25, 50, 100]
                ...
                "columns": [{
                    ...
                    <?php if ($this->efs_lib->is_can($permission, "edit")) { ?> {
                            ...
                            render: function(data, type) {
                                return '<a class="btn btn-info btn-xs" href="<?php echo base_url('sys/module/language/'); ?>' + data.id + '"><i class="fas fa-globe"></i></a>';
                            }
                        },
                        {
                            "data": {
                    ...
                    <?php if ($this->efs_lib->is_can($permission, "delete")) { ?> {
                            ...
                            render: function(data, type) {
                                if (data.created_username == 'system') {
                                    ...
                                    return '<button type="button" class="btn btn-danger btn-xs confirmDelete" data-href="<?php echo base_url('sys/module/child_delete/'); ?>' + data.id + '"><i class="fas fa-trash-alt"></i></button>';
                                }
                            }
                        },
                    <?php } ?>
                ...
                $('#mTable tbody').on('click', 'tr td #editBtn', function() {
                    ...
                    $.post("<?php echo base_url('sys/module/ajax_data'); ?>", {
                        ...
                        function(data) {
                            ...
                            $form.find('[name="module"]').val(data['module']);
